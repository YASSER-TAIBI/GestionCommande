 ...
 * @author Hp
 */
public class AnnulerCommandeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     void loadDetail(){
        ...
        listeCommande.clear();
        listeCommande.addAll(commandeDAO.findCommandeByEtat(Constantes.ETAT_COMMANDE_ANNULER, Constantes.COMMANDE_INTERNE));
   ...
   listeCommande.addAll(commandeDAO.findFourByRechercheNumCommande(numComRechField.getText(),Constantes.ETAT_COMMANDE_ANNULER));
   ...
   listeCommande.addAll(commandeDAO.findByDateCommande(dateSaisie,Constantes.ETAT_COMMANDE_ANNULER));
   ...
   tableCommande.setItems(listeCommande);
    ...
    private void imprimerOnAction(ActionEvent event) {
          ...
          HashMap para = new HashMap();
            JasperReport report = (JasperReport) JRLoader.loadObject(SuiviCommandeController.class.getResource(nav.getiReportBonCommandeAnnulerMP()));
