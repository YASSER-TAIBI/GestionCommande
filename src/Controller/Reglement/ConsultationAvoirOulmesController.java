 ...
 * @author Hp
 */
public class ConsultationAvoirOulmesController implements Initializable {
...
//           client2RechCombo.setItems(client);
    ...
    BigDecimal factureAvoir = BigDecimal.ZERO;
       ...
       void loadDetail(){
        ...
        listeAvoirOulmes.addAll(avoirOulmesDAO.findAvoirOulmesByEtat(Constantes.ETAT_REGLEMENT_AVOIR));
    ...
    @FXML
    private void rechercheMouseClicked(MouseEvent event) throws ParseException {
  ...
  String bonAvoir = nLivraisonRechField.getText();
       ...
       ClientMP clientMP = mapClientMP.get(clientCombo.getSelectionModel().getSelectedItem());
        ...
        if(dateDebut.getValue()!= null && dateFin.getValue()!= null){
          ...
          listeAvoirOulmes.addAll(avoirOulmesDAO.findByAllFilter(Constantes.ETAT_REGLEMENT_AVOIR,req));
    ...
    private void imprimerOnAction(ActionEvent event) {
        ...
        if (listeAvoirRadio.isSelected()==true){
          ...
          HashMap para = new HashMap();
            JasperReport report = (JasperReport) JRLoader.loadObject(ConsultationAvoirOulmesController.class.getResource(nav.getiReportConsultationAvoirRegler()));
         ...
         if (tableSituationAvoir.getSelectionModel().getSelectedIndex()!=-1){
                ...
                avoirOulmes=tableSituationAvoir.getSelectionModel().getSelectedItem();   
                       ...
                       try {
          HashMap para = new HashMap();
            JasperReport report = (JasperReport) JRLoader.loadObject(ConsultationAvoirOulmesController.class.getResource(nav.getiReportConsultationDetailAvoirRegler()));
