...
import static Controller.Livraision.SuiviCommandeOulmesController.setColumnTextFieldConverter;
 ...
 * @author Hp
 */
public class ConsultationCommandeRegionOulmesController implements Initializable {
  ...
  void setColumnProperties() {
    ...
    void loadDetail() {
        ...
        listeCommandeRegion.addAll(commandeRegionDAO.findByTypeComAndDepot(Constantes.COMMANDE_INTERNE_ART,nav.getUtilisateur().getDepot().getId()));
